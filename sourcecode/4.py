...
df2 = pd.read_csv('sourcecode/results.csv')
...
print(df)
df.to_csv("sourcecode/player_transfer_value.csv",index=False,encoding='utf-8-sig')
...
stats_df = pd.read_csv('sourcecode/results.csv')
values_df = pd.read_csv('sourcecode/player_transfer_value.csv')
...
# Hiển thị
os.makedirs("sourcecode/image/bai4", exist_ok=True)
plt.tight_layout()
plt.savefig(f'sourcecode/image/bai4/sosanhmohinh.png',dpi = 300)
...
df_filtered.to_csv('sourcecode/player_value_predictions.csv', index=False, encoding='utf-8-sig')